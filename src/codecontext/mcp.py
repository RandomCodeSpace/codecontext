...
def run_stdio(graph_db: str, backend: str = "falkordblite", verbose: bool = False) -> int:
...
def run_http(graph_db: str, addr: str, backend: str = "falkordblite", verbose: bool = False) -> int:
	try:
